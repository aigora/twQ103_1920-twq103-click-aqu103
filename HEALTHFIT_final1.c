...
int main(){
	system("color 3F");
	struct Registro persona[50];
	struct Usuario persona1[1];
	...
	switch(opcion1){
		...
		case 'A': {
			...
			scanf("%s", persona1[1].usuario2);
			longUsuario2=strlen(persona1[1].usuario2);
		    	if(longUsuario2<4)
		  		printf("Al menos tiene que tener 4 caracteres\n");	  
			}while(longUsuario2<4);
			
			for(i=0;i<=contador;i++){
				if(strcmp(persona[i].usuario1,persona1[1].usuario2)==0){
					chivato1=1;
			...
			if(chivato1==1){
				...
				scanf("%i",&persona1[1].contrasenia);
				
				for(i=0;i<=contador;i++){
					if(strcmp(persona[i].usuario1,persona1[1].usuario2)==0){
						if(persona[i].password == persona1[1].contrasenia){
						chivato2=1;
					}
				}
			}
		...
		case 'B':{
		    ...
		    printf("Nombre: ");
		    fflush(stdin);
		    scanf("%s",persona[contador].nombre);
		    
		    
		    fflush(stdin);
		    printf("Apellidos: ");
		    gets(persona[contador].apellidos);
		   
		    do{
		    printf("Edad: ");
		    scanf("%d",&persona[contador].edad);
		    if(persona[contador].edad<10)
		        printf("No admite menor de 10 anios\n");
		        fflush(stdin);
		     
		   	}while(persona[contador].edad<10);
		   	
		    
		    fflush(stdin);
		    printf("Correo: ");
		    gets(persona[contador].correo);
		    ...
		    do{
		    	chivato=0;
		    printf("Usuario: ");
		    gets(persona[contador].usuario1);
		    longUsuario1=strlen(persona[contador].usuario1);
		    if(longUsuario1<4)
		     ...
		     for(i=0;i<contador;i++){
		    	if(strcmp(persona[contador].usuario1,persona[i].usuario1)==0){
		    		chivato=1;
		    ...
		    scanf("%i", &persona[contador].password);
		    do{
		    printf("verificar contrase%ca: ",164);
		    scanf("%i", &persona[contador].contra);
		    
		    if(persona[contador].password==persona[contador].contra){
		    	system("cls");
		   
			}else{
				printf("contrase%ca no v%clida\n",164,160);
			}
	    	}while(persona[contador].contra!=persona[contador].password);
	    	contador++;
